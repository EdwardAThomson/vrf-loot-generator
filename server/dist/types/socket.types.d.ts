...
export interface SocketMessage {
    type: 'PLAYER_JOIN' | 'PLAYER_LEAVE' | 'ROOM_JOIN' | 'ROOM_LEAVE' | 'TRADE_INITIATE' | 'TRADE_COMMIT' | 'TRADE_REVEAL' | 'TRADE_COMPLETE' | 'TRADE_CANCEL' | 'PLAYER_LIST_REQUEST' | 'ROOM_LIST_REQUEST';
    playerId: string;
    roomId?: string;
    payload: any;
    timestamp: number;
